...
function Url({ selectQuesType, form }) {
  ...
  return (
    <div className=' w-full '>
      ...
      <input placeholder='https://postontrends.com' className='w-full p-2 border border-[#E1E4E8] rounded-lg mt-2 bg-[#F6F8FA]' type='text' disabled />
    </div>
  )
}
